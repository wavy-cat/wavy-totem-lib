...
1. Your skin, as an instance of the [Skin](/en/concepts/skin) class;
2. An algorithm that will draw the totem, i.e., a [Pattern](/en/concepts/pattern/). By default, the [Wavy](/en/concepts/pattern#wavy) pattern is used;
3. A [Builder](/en/concepts/builder), which combines the two previous components and returns a [Totem](/en/concepts/totem).
...
2. Create a totem builder:
    ...
    The builder accepts several optional arguments that affect the final totem texture. Read more on the [Builder](/en/concepts/builder) page in the Concepts section.
...
After these steps, you will receive an instance of the [Totem](/en/concepts/totem) class, which contains a PIL.Image object in its `image` property.
